...
//		candidateServiceImpl.addCandidateWithCertificate();
	...
	static void menu() {
		...
		System.out.println("2. Print all Candidate's name");
		System.out.println("3. Print all Candidate Duplicate Email");
		System.out.println("4. Show All Candidate");
		System.out.println("5. Print all Candidate Sort");
		System.out.println("6. Update Candidate ");
		System.out.println("7. Insert Candidate ");
		...
		case "1":
			...
			break;
		case "2":
			candidateServiceImpl.printCandidateFullName();
			break;
		case "3":
			candidateServiceImpl.duplicateEmailCandidate();
			break;
		case "4":
			candidateServiceImpl.showInfo();
			break;
		case "5":
			candidateServiceImpl.sortCandidate();
			break;
		case "6":
			candidateDAOImpl.updateViaResultSet();
			break;
