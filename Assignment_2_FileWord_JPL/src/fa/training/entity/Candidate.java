...
public abstract class Candidate implements Comparable<Candidate> {
	...
	private List<CandidateCertificate> listCertificate;
	...
	public List<CandidateCertificate> getListCertificate() {
		return listCertificate;
	}

	public void setListCertificate(List<CandidateCertificate> listCertificate) {
	...
	public int compareTo(Candidate one) {
		if (one.getCandidateType() > this.getCandidateType()) {
			...
			// so sanh String
//			return  one.getFullName().compareTo(this.getFullName());
//			return  -one.getFullName().compareTo(this.getFullName());
		}
	}
